...
describe("Employee Upload Document Tests", () => {
    ...
    it.only("HRMIS_3:Verify that documents gets uploaded after clicking on 'Submit' button", () => {
        ...
        UploadEmpDocumentPage.checkDownloadFile('cypress/downloads/dummy.pdf');
